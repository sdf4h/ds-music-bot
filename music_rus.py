...
bot = commands.Bot('bot.',intents=intents, description='Крутой бот от gbcmrbyjuj lhsof.')
...
bot.run('MTA2Nzg3Njk0MTQxNzQzNTI4OA.G5mqJ8.EvwVRMVObdOEf1LvBvu0TuOoXCWXhXsgoFff8Y')